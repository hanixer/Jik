...
let appendToBuilder (builder : StringBuilder) (args : DataReceivedEventArgs) =
    if System.String.IsNullOrEmpty args.Data |> not then
...
let executeProcess (exe,cmdline) =
    ...
    p.OutputDataReceived.Add(appendToBuilder output)
